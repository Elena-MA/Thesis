...
/**
 * @brief cDetector::detectorTask call to all functions to perform the detection.
 */
...
/**
 * @brief cDetector::recognizeMarkers
 * ordering markers according to its IDs
 */
...
/**
 * @brief cDetector::createMessage codifying output message
 */
...
/**
 * @brief cDetector::orderDetection
 * @param detection
 * @return vector of markers ordered by its IDs in ascendent order
 */
